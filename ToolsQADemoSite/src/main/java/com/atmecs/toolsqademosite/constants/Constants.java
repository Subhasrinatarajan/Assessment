package com.atmecs.toolsqademosite.constants;
...
public class Constants extends TestBase {
	...
	public final static String EXPECTEDTITLE_FILE = EXPECTEDTITLE_HOME + "expecteddataset.properties";
	...
	public final static String KEYVALUE_FILE = KEYVALUE_HOME + "thirdpageproductcolor.xlsx";
	
	public final static String BLACKTSHIRTIMAGE_HOME = USERS_HOME + "image-validation" + File.separator;
	public final static String BLACKTSHIRTIMAGE_FILE = BLACKTSHIRTIMAGE_HOME + "shophmpg_productvalidation.png";
	
	public final static String PRODUCTLIST_HOME = USERS_HOME + "resources" + File.separator+"testdata"+File.separator;
	public final static String PRODUCTLIST_FILE = PRODUCTLIST_HOME + "thirdpageproductlist.xlsx";
